...
let data = Map({ id: 1, title: "Blanditiis quidem aut sit", short_title: "CSS", description: "Molestiae omnis fugiat laborum Quis sint aute ea odio hic qui officiis ab molestiae", tasks: List([Map({instructions: "Laudantium ut veritatis et magnam ducimus quis aute cum sunt ex explicabo Nemo blanditiis excepturi", link: "Temporibus mollitia eum quis consequatur vero quaerat similique aut autem dolore culpa culpa et totam totam", task: "Autem consequatur" }) ]), selected: false });
